...
#include <stdint.h>
#include <stdlib.h>
// Added by myself, to use: trigger_high(), trigger_low(), trigger_setup(), init_uart()
#include "simpleserial.h"
#include "hal.h"

// Command to compile the code:
// make PLATFORM=CWLITEXMEGA
// make PLATFORM=CWLITEXMEGA FIRMWAREPATH=../chipwhisperer/firmware/mcu
...
uint8_t handle(uint8_t cmd, uint8_t scmd, uint8_t len, uint8_t *buf)
{
  ...
  // TODO implement a simple RSA vulnerable to SPA attack, check S1 latex file to find a good paper
